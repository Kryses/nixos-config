...
# sudo mount -t cifs //192.168.1.232/development /home/kryses/documents/work -o username="cprovencher,password=***REMOVED***,uid=1000,gid=1000,iocharset=utf8,file_mode=0664,dir_mode=0755,mfsymlinks"
